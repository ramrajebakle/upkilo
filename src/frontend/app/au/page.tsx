    ...
    <main className="min-h-screen bg-card">
      ...
      <section className="py-16 px-4 bg-muted">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-foreground-secondary mb-12">Prices in USD, excluding GST. Cancel anytime.</p>
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((p) => (
              <div key={p.name} className={`rounded-2xl p-8 ${p.highlight ? 'bg-green-900 text-white shadow-xl scale-105' : 'bg-card border border-border'}`}>
