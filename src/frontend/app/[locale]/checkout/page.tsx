        ...
        <div className="min-h-screen bg-muted">
            <div className="max-w-4xl mx-auto py-12 px-4">
                <div className="text-center mb-8">
                    ...
                    <p className="text-foreground-secondary mt-2">14-day free trial included</p>
                </div>
                        ...
                        <div className="bg-card rounded-xl shadow-sm p-6">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            !isAnnual ? 'bg-primary-500 text-white' : 'bg-gray-200 text-foreground-secondary'
                                        )}
                                    >
                                        Monthly
                                    </button>
                            ...
                            <div className="flex gap-2 mb-6">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 border border-border-strong rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                                />
                                <button className="px-4 py-2 bg-muted text-foreground rounded-lg hover:bg-gray-200">
                                    Apply
                                </button>
                            </div>
