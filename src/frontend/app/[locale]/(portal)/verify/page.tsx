            ...
            <Card className="w-full max-w-md p-8 text-center animate-fade-in-up">
                {status === 'verifying' && (
                    <div className="space-y-6">
                        ...
                        <h1 className="text-2xl font-bold text-slate-900">Verifying your link...</h1>
                        <p className="text-slate-500 text-sm">One moment while we secure your session.</p>
                    </div>
                )}
                ...
                {status === 'success' && (
                    <div className="space-y-6">
                        ...
                        <h1 className="text-2xl font-bold text-slate-900">Sign in successful!</h1>
