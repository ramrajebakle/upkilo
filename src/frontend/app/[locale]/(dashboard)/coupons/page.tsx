                            ...
                            {loading && coupons.length === 0 ? (
                                ...
                                <tr>
                                    <td colSpan={6} className="px-6 py-16 text-center">
                                        ...
                                        <h3 className="text-base font-semibold text-slate-900 mb-1">{t('noCoupons')}</h3>
                                        <p className="text-sm text-slate-500 max-w-[200px] mx-auto">{t('noCouponsDesc')}</p>
                                    </td>
                                </tr>
                            ) : (
                                coupons.map((coupon) => (
                                    <tr key={coupon.id} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-1.5 font-semibold text-slate-900">
                                                {coupon.discountType === 'Percentage' ? <Percent className="h-3 w-3 text-slate-400" /> : <span className="text-slate-400 font-normal">$</span>}
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-5">
                            ...
                            <div className="pt-4 flex gap-3">
                                <button
                                    ...
                                    className="flex-1 px-4 py-3 text-sm font-semibold text-slate-700 bg-slate-100 rounded-2xl hover:bg-slate-200 transition-all active:scale-95"
                                >
                                    {common('cancel')}
                                </button>
                                <button
