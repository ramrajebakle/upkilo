        ...
        <div className="flex items-center justify-center min-h-[60vh] p-6">
            <div className="text-center space-y-6 max-w-md animate-fade-in-up">
                <div className="mx-auto h-16 w-16 flex items-center justify-center rounded-2xl bg-gradient-to-br from-red-50 to-orange-50 border border-red-100">
                    <svg className="h-8 w-8 text-danger-fg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-card text-foreground rounded-xl font-medium border border-border hover:border-primary-300 transition-all text-sm"
                    >
                        Back to Dashboard
                    </button>
                </div>
