...
import { Undo2, Redo2, ArrowLeft, FileText, PlusCircle, Settings, Layout, Save, Trash2, Info, ChevronUp, ChevronDown, Plus, Tag, CheckCircle2, Type, Copy, List, CheckSquare } from 'lucide-react';
...
export default function NewFormPage() {
    ...
    const {
        ...
        defaultValues: {
            ...
            status: 'active',
            isRequired: false,
            fields: [{ id: Math.random().toString(36).substr(2, 9), label: 'Full Name', type: 'text', required: true }]
        }
    });
    ...
    const onSubmit = async (data: FormBuilderData) => {
        ...
        try {
            ...
            await api.forms.create(submissionData);
            toastSuccess('Form created successfully');
            router.push('/forms?created=true');
        } catch (error) {
