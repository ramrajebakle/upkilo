        ...
        return (
            <div className="max-w-5xl mx-auto animate-pulse space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-3 h-96 bg-muted rounded-2xl" />
                </div>
            </div>
        );
    }
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8 animate-fade-in-up">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-foreground-secondary ml-12">Update your custom intake or consent form</p>
                </div>
                <div className="flex gap-2">
                    <div className="flex items-center gap-1 mr-4 pr-4 border-r border-border">
                        <button
                            type="button"
                            onClick={handleUndo}
                            disabled={!canUndo}
                    ...
                    <button type="button" className="p-2 hover:bg-accent text-foreground-muted hover:text-primary rounded-xl transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="card-elevated p-5 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                            ...
                            <div className="space-y-4">
                                <div className="text-center p-3 bg-muted rounded-xl border border-border-subtle">
                                    <p className="text-xl font-bold text-foreground">{responses}</p>
                                    <p className="text-[10px] text-foreground-muted uppercase tracking-widest font-bold">Total Responses</p>
                                </div>
                            </div>
                        </div>
                    </div>
