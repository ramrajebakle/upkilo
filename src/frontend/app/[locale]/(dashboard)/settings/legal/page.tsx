...
export default function LegalSettingsPage() {
    ...
    return (
        <div className="max-w-4xl space-y-8">
            ...
            {loading ? (
                <div className="p-8 text-center text-slate-500">Loading legal documents...</div>
            ) : (
                    ...
                    <div className="card-elevated p-6">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Rules users must agree to in order to use your service.</p>
                            </div>
                        </div>
                        <textarea
                            className="w-full h-64 p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all resize-none text-slate-700 font-mono text-sm"
                    ...
                    <div className="card-elevated p-6">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Details on how you collect, use, and protect user data.</p>
                            </div>
                        </div>
                        <textarea
                            className="w-full h-64 p-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all resize-none text-slate-700 font-mono text-sm"
