                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className={cn(
                                                                ...
                                                                isDirty && !isMissing && 'bg-primary-50/30'
                                                            )}
                                                        >
                                                            {/* English source */}
                                                            <div>
                                                                ...
                                                                {isEditing ? (
                                                                    <div className="flex-1">
                                                                        <textarea
                                                                            ...
                                                                            dir={isRtl ? 'rtl' : 'ltr'}
                                                                            className="w-full px-2 py-1.5 border border-primary-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-400 resize-none"
                                                                            rows={2}
                                                                        />
