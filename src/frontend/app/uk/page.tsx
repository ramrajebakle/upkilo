    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-6 px-4 border-b">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-6">
          {['GDPR Compliant', 'UK Data Residency', 'ICO Registered', 'DPA Template Included', 'VAT Supported'].map(t => (
            <span key={t} className="inline-flex items-center gap-1.5 text-sm text-gray-600 font-medium">
              <Check className="h-4 w-4 shrink-0 text-green-600" aria-hidden="true" strokeWidth={2.5} />
              {t}
            </span>
          ))}
        </div>
      ...
      <section id="pricing" className="bg-gray-50 py-20 px-4 border-t">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12">One price for every region — billed in USD. What you see is what you pay.</p>
          ...
          <p className="text-center text-sm text-gray-400 mt-6">Prices in USD, excluding VAT. 14-day free trial. No credit card required.</p>
        </div>
      </section>
