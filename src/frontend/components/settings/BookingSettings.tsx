        ...
        <div className="space-y-10">
            ...
            <Card className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[40px] shadow-2xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
                <CardHeader className="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/20">
                    ...
                    <CardDescription className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.3em] mt-1">Global scheduling authorizations</CardDescription>
                </CardHeader>
                <CardContent className="p-8 space-y-8">
                    <div className="grid gap-6">
                        <label className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <span className="text-[9px] font-black text-foreground-muted uppercase tracking-widest block">Clients can initiate bookings via network portal</span>
                            </div>
                        </label>
                        ...
                        <label className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <span className="text-[9px] font-black text-foreground-muted uppercase tracking-widest block">Mandatory financial clearance upon booking dispatch</span>
                            </div>
                        </label>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.4em]">Min. Preparation (Hours)</Label>
                            <Input
                                type="number"
                        ...
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.4em]">Horizon limit (Days)</Label>
                            <Input
                                type="number"
            ...
            <Card className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[40px] shadow-2xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
                <CardHeader className="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/20">
                    ...
                    <CardDescription className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.3em] mt-1">Rules for engagement modification</CardDescription>
                </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <label className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <span className="text-[8px] font-black text-foreground-muted uppercase tracking-widest block">Clients can abort confirmed slots</span>
                            </div>
                        </label>
                        ...
                        <label className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <span className="text-[8px] font-black text-foreground-muted uppercase tracking-widest block">Authorized reallocation of booking time</span>
                            </div>
                        </label>
                    </div>

                    <div className="space-y-4">
                        <Label className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.4em]">Protocol Dead-Zone (Hours)</Label>
                        <Input
                            type="number"
                            ...
                            className="h-14 px-6 bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-black rounded-2xl"
                        />
                        <p className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest pl-2">Minimum latency before appointment for modification authorization.</p>
                    </div>

                    <div className="space-y-4">
                        <Label className="text-[10px] font-black text-foreground-muted uppercase tracking-[0.4em]">Policy Legalist Text</Label>
                        <textarea
                        ...
                        />
                        <p className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest pl-2">Dispatched to nodes during terminal engagement.</p>
                    </div>
